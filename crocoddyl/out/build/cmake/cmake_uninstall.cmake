...
IF(NOT EXISTS "/home/jianghan/devel/workspace/src/ur10e_obstacle_avoidance/crocoddyl/out/build/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/home/jianghan/devel/workspace/src/ur10e_obstacle_avoidance/crocoddyl/out/build/install_manifest.txt")
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/home/jianghan/devel/workspace/src/ur10e_obstacle_avoidance/crocoddyl/out/build/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/home/jianghan/devel/workspace/src/ur10e_obstacle_avoidance/crocoddyl/out/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
